...
// NAVBAR DINÁMICO - Agregar después de tu código existente

let lastScrollTop = 0;

// Función para manejar el comportamiento del navbar en scroll
function handleNavbarScroll() {
    ...
    lastScrollTop = scrollTop <= 0 ? 0 : scrollTop; // Para Mobile o negative scrolling
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Agregar comportamiento dinámico al navbar
    window.addEventListener('scroll', throttle(handleNavbarScroll, 100));
});

// ALTERNATIVA: Navbar que se oculta después de cierta distancia
function hideNavbarAfterDistance() {
    const navbar = document.querySelector('.navbar');
    const scrollTop = window.pageYOffset;
    const hideDistance = 100; // pixels
...
// Para usar la alternativa, cambia la función en el event listener:
// window.addEventListener('scroll', throttle(hideNavbarAfterDistance, 100));
